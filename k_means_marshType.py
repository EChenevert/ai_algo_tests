...
d['Organic Mass Accumulation (g/time)'] = (d['Bulk_Densi'] * d['Average_Ac_cm'] * (d['Organic_Ma']/100)) * A
...
sns.pairplot(d[['Total Mass Accumulation (g/time)', 'Organic Mass Accumulation (g/time)',
                'Mineral Mass Accumulation (g/time)', "Distance_to_Ocean__m_", "Distance_to_Fluvial_m",
                'Organic Mass Accumulation Fraction', 'Average_Ac_cm']])
plt.show()
...
for col in dmdf2.columns.values[9:]:
    print(col)
